module RedminePortfolioManagement
    ...
    module Redmine
		...
		# Faz a leitura dos campos de configuração do Plugin
		#
		...
		# Carrega o Objeto do Campo Personalizado definido para nomear os Portfolios
		#
		# @return [CustomField] o Objeto do Campo customizado
		# @author Marcus Sacramento
        def portfolio_management_attribute
            custom_field(:portfolio_management_attribute)
        end
        
        # Carrega o Objeto do Campo Personalizado definido para os gerentes de Portfolio
		#
		# @return [CustomField] o Objeto do Campo customizado
		# @author Marcus Sacramento
		...
		# Carrega o Objeto do Campo Personalizado definido para visibilidade dos Portfolios
		#
		# @return [CustomField] o Objeto do Campo customizado
		# @author Marcus Sacramento
		...
		# Listagem dos Portfolios que possuem projetos
		#
		# @return [Array] Objetos que representam os portfolios, `:integer`, `:text`, `text`
		# @author Marcus Sacramento
		# @note Este Método retorna o valor a ser usado como id nas tabelas geradas. Retirar o regexp do SQL e transformar o campo value para o mesmo formato, sem caracter especial
		...
		# Listagem dos Projetos associados a um Portfolio
		#
		# @param format [type],[name] O tipo do campo customizado e o nome do portfolio, `:integer` or `:text`
		# @return [Array] Objetos que representam os projetos do portfolio
		# @author Marcus Sacramento
		...
		#
		# @param format [id] O Id do Projeto, `:integer`
		# @return [Array] Objetos que representam a data de Início do Projeto
		# @author Marcus Sacramento
		# @note A Busca se baseia na menor data de início dentre as tarefas do Projeto
		...
		#
		# @param format [id] O Id do Projeto, `:integer`
		# @return [Array] Objetos que representam a data de Fim do Projeto
		# @author Marcus Sacramento
		# @note A Busca se baseia na maior data de fim dentre as tarefas do Projeto
		...
		#
		# @param format [id] O Id do Projeto, `:integer`
		# @return [Array] Objetos que representam o Responsável do Projeto
		# @author Marcus Sacramento
		...
		# Cálculo de Percentual concluído do Projeto
		#
		# @param format [id] O Id do Projeto, `:integer`
		# @return [String] Texto com o % de tarefas concluídas do Projeto
		# @author Marcus Sacramento
